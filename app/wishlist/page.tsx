    ...
    return (
      <div className="container mx-auto p-4 lg:p-8 min-h-[60vh] flex flex-col items-center justify-center space-y-6 animate-in fade-in duration-700 text-center">
        ...
        <div className="space-y-2">
          <h2 className="text-3xl font-black tracking-tight">{t.wishlist.empty}</h2>
    ...
    <div className="container mx-auto p-4 lg:p-8 space-y-8 animate-in fade-in duration-700 pb-20 lg:pb-8">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button
          ...
          className="px-4 py-2 rounded-xl border border-rose-200 text-rose-600 hover:bg-rose-50 font-black text-sm transition-all cursor-pointer"
        >
          {t.wishlist.clearAll}
        </button>
      </div>
          ...
          >
            ...
            <div className="p-4 space-y-3 flex-1 flex flex-col">
              ...
              <button
                ...
                className="w-full h-12 rounded-xl bg-primary text-primary-foreground font-black text-sm hover:opacity-90 transition-all flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-primary/20"
              >
