      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 lg:gap-8">
        {displayData.map((product) => (
          <div 
            ...
            className="group bg-card rounded-2xl border overflow-hidden hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 cursor-pointer flex flex-col"
          >
            ...
            <div className="p-4 lg:p-6 space-y-3 flex-1 flex flex-col justify-between">
