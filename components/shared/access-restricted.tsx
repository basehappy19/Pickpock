  ...
  return (
    <div className="container mx-auto px-4 py-20 flex flex-col items-center justify-center text-center space-y-8 animate-in fade-in duration-700">
      ...
      <div className="space-y-3 relative z-10">
        <h2 className="text-3xl font-black tracking-tight uppercase">Access Restricted</h2>
      ...
      <div className="flex flex-col sm:flex-row gap-4 w-full max-w-sm relative z-10">
        <button 
          ...
          className="flex-1 h-14 rounded-2xl bg-primary text-primary-foreground font-black flex items-center justify-center gap-2 hover:scale-105 active:scale-95 transition-all shadow-xl shadow-primary/20 cursor-pointer"
        >
          <RefreshCw className="h-5 w-5" /> Switch to {requiredRole[0]}
        </button>
      </div>
      
      <p className="text-xs text-muted-foreground font-black uppercase tracking-widest pt-4 opacity-50">
